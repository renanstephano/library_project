...
import static com.renanstephano.bookstoremanager.utils.JsonConversionUtils.asJsonString;
...
public class AuthorControllerTest {
    ...
    @Test
    void whenPOSTIsCalledWithoutRequiredFiledThenBadRequestShouldBeInformed() throws Exception {
        AuthorDTO expectedCreatedAuthorDTO = authorDTOBuilder.buildAuthorDTO();
